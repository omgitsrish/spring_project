				...
				<div class="row">
					<div class="col-lg-12 ">
						<div class="alert alert-info">
							<strong>Welcome User ! </strong> You Have No pending New
							Messages.
						</div>
				...
				<div class="row">
					<div class="col-lg-12 ">
						...
						<ul class="nav nav-tabs">
							<li class="active"><a href="#record" data-toggle="tab">Current
									Salary</a></li>
							<li class=""><a href="#increment" data-toggle="tab">Increments</a>
							</li>
							<li class=""><a href="#estimate" data-toggle="tab">Project
									Estimates</a></li>
						...
						<div class="tab-content">
							<div class="tab-pane fade active in" id="record">
								...
								<p>
									<a href="${pageContext.request.contextPath }/Give_Salary">Give
								...
								Salary:<c:out value="${s.getSalary() }"></c:out>
									...
									Give option for selecting each employee for details with
									increments<BR>
